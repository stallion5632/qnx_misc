...
const char data[BLOCK_BYTES] =
    "This program creates a pair of connected sockets, then forks and communicates over them. This is very similar to "
    "communication with pipes, however, socketpairs are two-way  communications  objects. Therefore I can send "
...
int main(int argc, char *argv[]) {
  ...
  for (size_t i = 0; i < num_blks; ++i) {
    if (sendto(sock, data, BLOCK_BYTES, 0, (struct sockaddr *)&receiver, sizeof(receiver)) < 0) {
